...
export const NOTAUTHORIZED = 'notAutorized'; // - User has not initiated authorization
export const ISAUTHORIZING = 'isAuthorizing'; // - Authorization in progress, Google Modal in the foreground

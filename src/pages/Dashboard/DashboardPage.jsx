                ...
                message: (
                    <div style={{ display: 'flex', alignItems: 'center' }}>
                        ...
                        <h4
                            ...
                            style={{ lineHeight: '16px' }}
                        >
                            Successfully added an email! Please wait a few
                            minutes to show your returns on the dashboard
                        </h4>
                    </div>
                ),
            });
        ...
        <div id='DashboardPage'>
            <div className='container mt-6 main-mobile-dashboard'>
                ...
                <div className='row ipad-row'>
                    <div
                        className={`mt-4 w-840 bottom ${
                            isTablet ? 'col' : 'col-sm-9'
                        }`}
                    >
                        {(loading || showScanning) && (
                            <>
                                <h3
                                    className={`sofia-pro text-16 ${
                                        isMobile ? 'ml-3' : ''
                                    }`}
                                >

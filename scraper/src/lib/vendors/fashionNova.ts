...
export default class FashionNova {
  ...
  static async getOrderRef(root: Document): Promise<string | null> {
    try {
      const orderRefElement = root.querySelector(
        'html > body > table:nth-child(3) > tbody > tr > td > table:nth-child(1) > tbody > tr:nth-child(1) > td > table > tbody > tr > td:nth-child(2) > table:nth-child(1) > tbody > tr:nth-child(4) > td > a'
      );
  ...
  static async getOrderDate(root: Document): Promise<number | null> {
    try {
      const orderDateElement = root.querySelector(
        'html > body > table:nth-child(3) > tbody > tr > td > table:nth-child(1) > tbody > tr:nth-child(1) > td > table > tbody > tr > td:nth-child(2) > table:nth-child(1) > tbody > tr:nth-child(4) > td'
      );
  ...
  static async getProducts(root: Document): Promise<RawProduct[]> {
    try {
      const initialContainer = root.querySelector(
        'html > body > table:nth-child(3) > tbody > tr > td > table:nth-child(1) > tbody > tr:nth-child(2) > td > table > tbody > tr > td:nth-child(2) > table > tbody'
      );
      ...
      initialContainer.querySelectorAll('tr').forEach((item) => {
        ...
        if (item) {
          hasProductName = item.querySelector(
            'td > table > tbody > tr > td:nth-child(4) > table > tbody > tr:nth-child(2) > td > a'
          );
        }

        const isProduct = !!hasProductName && item.childNodes.length === 15 && item.children.length === 7;
        if (isProduct) {
      ...
      orderTableContainer.forEach((item) => {
        ...
        const productPriceElement = productRowElement.querySelector(
          'td > table > tbody > tr > td:nth-child(6) > table > tbody > tr:nth-child(2) > td'
        );

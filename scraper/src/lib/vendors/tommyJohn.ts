...
export default class TommyJohn {
  ...
  static async getOrderRef(root: Document): Promise<string | null> {
    try {
      const orderRefElement = root.querySelector(
        'body > table > tbody > tr > td > table:nth-child(2) > tbody > tr > td > center > table > tbody > tr > td > div > h4:nth-child(1) > span > a'
      );
  ...
  static async getOrderDate(root: Document): Promise<number | null> {
    try {
      const orderRefElement = root.querySelector(
        'body > table > tbody > tr > td > table:nth-child(2) > tbody > tr > td > center > table > tbody > tr > td > div > h4:nth-child(2) > span > time'
      );
  ...
  static async getProducts(root: Document): Promise<RawProduct[]> {
    try {
      const initialContainer = root.querySelector(
        'body > table > tbody > tr > td > table:nth-child(4) > tbody > tr > td > center > table > tbody > tr > td > table:nth-child(1) > tbody'
      );

  ...
  static async getOrderRef(root: Document): Promise<string | null> {
    try {
      const orderRefElement = root.querySelector(
        'html > body > custom > table > tbody > tr > td > div > table > tbody > tr:nth-child(4) > td > table:nth-child(1) > tbody > tr:nth-child(1) > td > table > tbody > tr > td:nth-child(1) > table > tbody > tr:nth-child(1) > td'
      );
  ...
  static async getOrderDate(root: Document): Promise<number | null> {
    try {
      const orderDateElement = root.querySelector(
        'html > body > custom > table > tbody > tr > td > div > table > tbody > tr:nth-child(4) > td > table:nth-child(1) > tbody > tr:nth-child(1) > td > table > tbody > tr > td:nth-child(1) > table > tbody > tr:nth-child(2) > td'
      );

      const orderDate = orderDateElement
        ? orderDateElement.textContent.split('at').shift()?.trim().split(' ').slice(1).join(' ')
        : null;
  ...
  static async getProducts(root: Document): Promise<RawProduct[]> {
    try {
      const initialContainer = root.querySelector(
        'html > body > custom > table > tbody > tr > td > div > table > tbody > tr:nth-child(4) > td > table:nth-child(1) > tbody > tr:nth-child(6) > td > table > tbody > tr > td > table > tbody'
      );
      const orderTableContainer = [];

      initialContainer.querySelectorAll('tr').forEach((item) => {
        const hasThumbnail = item
          .querySelector('td > table > tbody > tr > td:nth-child(1) > table > tbody > tr > td > img')
          ?.getAttribute('src');
      ...
      orderTableContainer.forEach((item) => {
        ...
        const productNameElement = productRowElement.querySelector(
          'td > table > tbody > tr > td:nth-child(2) > table > tbody > tr:nth-child(1) > td > a > span'
        );
        const productName = productNameElement.textContent.trim() || /* istanbul ignore next */ '';

        const productQuantityElement = productRowElement.querySelector(
          'td > table > tbody > tr > td:nth-child(2) > table > tbody > tr:nth-child(2) > td'
        );
        ...
        const productThumbnailElement = productRowElement.querySelector(
          'td > table > tbody > tr > td:nth-child(1) > table > tbody > tr > td > img'
        );
        ...
        const productPriceElement = productRowElement.querySelector(
          'td > table > tbody > tr > td:nth-child(3) > table > tbody > tr > td > span'
        );
        const price = /* istanbul ignore next */ productPriceElement.textContent.trim();

  ...
  static async getOrderRef(root: Document): Promise<string | null> {
    try {
      const orderRefElement = root.querySelector(
        'body > table > tbody > tr > td > table.row.content > tbody > tr > td > center > table > tbody > tr > td > table > tbody > tr:nth-child(1) > td > span.order-number__text'
      );

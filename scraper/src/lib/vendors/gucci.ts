...
export default class Gucci {
  ...
  static async getOrderRef(root: Document): Promise<string | null> {
    try {
      const orderRefElement = root.querySelector(
        'body > table > tbody > tr:nth-child(4) > td > table > tbody > tr:nth-child(2) > td > table > tbody > tr > td.padded > table > tbody > tr:nth-child(7) > td'
      );
  ...
  static async getProducts(root: Document): Promise<RawProduct[]> {
    try {
      const initialContainer = root.querySelector('body > table > tbody > tr:nth-child(4) > td > table > tbody');

      const orderTableContainer = [];

      initialContainer.querySelectorAll('tr').forEach((item) => {
        const hasThumbnail = item.querySelector(
          'td:nth-child(2) > table > tbody > tr > td > table > tbody > tr > td > div:nth-child(1) > table > tbody > tr > td > table > tbody > tr:nth-child(1) > td > a > img'
        );
      ...
      orderTableContainer.forEach((item) => {
        ...
        const productNameElement = productRowElement.querySelector(
          'td:nth-child(2) > table > tbody > tr > td > table > tbody > tr > td > div:nth-child(2) > table > tbody > tr > td > table > tbody > tr:nth-child(1) > td'
        );
        const productName = productNameElement.textContent.trim() || '';

        const productQuantityElement = productRowElement.querySelector(
          'td:nth-child(2) > table > tbody > tr > td > table > tbody > tr > td > div:nth-child(3) > table > tbody > tr > td > table >  tbody > tr:nth-child(3) > td'
        );
        ...
        const productPriceElement = productRowElement.querySelector(
          'td:nth-child(2) > table > tbody > tr > td > table > tbody > tr > td > div:nth-child(3) > table > tbody > tr > td > table >  tbody > tr:nth-child(2) > td'
        );

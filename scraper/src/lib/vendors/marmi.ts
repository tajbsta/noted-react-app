  ...
  static async getOrderRef(root: Document): Promise<string | null> {
    try {
      const orderRefElement = root.querySelector(
        'body > table > tbody > tr > td > table > tbody > tr:nth-child(2) > td > table:nth-child(4) > tbody > tr:nth-child(2) > td > p > b > span'
      );
  ...
  static async getProducts(root: Document): Promise<RawProduct[]> {
    try {
      const initialContainer = root.querySelector(
        'body > table > tbody > tr > td > table > tbody > tr:nth-child(2) > td > table:nth-child(5) > tbody > tr > td > table.email-items'
      );
      ...
      orderTableContainer.forEach((item) => {
        ...
        const productNameElement = productRowElement.querySelector('td:nth-child(2) > p');
        const productName = productNameElement.textContent.trim() || /* istanbul ignore next */ '';

        const productQuantityElement = productRowElement.querySelector('td:nth-child(2) > div:nth-child(3) > p');
        const productQuantity = productQuantityElement.textContent.trim().slice(-1);
        ...
        const productPriceElement = productRowElement.querySelector('td:nth-child(3) > p > span');

...
export default class UrbanOutfitters {
  ...
  static async getOrderRef(root: Document): Promise<string | null> {
    try {
      const orderRefElement = root.querySelector(
        'body > table > tbody > tr > td > table > tbody > tr:nth-child(2) > td > table:nth-child(1) > tbody > tr:nth-child(2) > td > h4 > a'
      );
  ...
  static async getProducts(root: Document): Promise<RawProduct[]> {
    try {
      const initialContainer = root.querySelector(
        'body > table > tbody > tr > td > table > tbody > tr:nth-child(2) > td > table:nth-child(1) > tbody > tr:nth-child(4) > td > table:nth-child(4) > tbody'
      );

      const orderTableContainer = [];

      initialContainer.querySelectorAll('tr').forEach((item) => {
        const hasTumbnail = item.querySelector('td > table > tbody > tr:nth-child(1) > td:nth-child(1) > a > img');
        const isProduct = !!hasTumbnail && item.children.length === 1 && item.childNodes.length === 3;
      ...
      orderTableContainer.forEach((item) => {
        ...
        const productNameElement = productRowElement.querySelector(
          'td > table > tbody > tr:nth-child(1) > td:nth-child(2) > table > tbody > tr:nth-child(1) > td > h4'
        );
        const productName = productNameElement.textContent.trim() || /* istanbul ignore next */ '';

        const productQuantityElement = productRowElement.querySelector(
          'td > table > tbody > tr:nth-child(1) > td:nth-child(4)'
        );
        ...
        const productThumbnailElement = productRowElement.querySelector(
          'td > table > tbody > tr:nth-child(1) > td:nth-child(1) > a > img'
        );
        ...
        const productPriceElement = productRowElement.querySelector(
          'td > table > tbody > tr:nth-child(1) > td:nth-child(3)'
        );
